    ...
    return (
        <div className="relative h-screen bg-white text-black selection:bg-black/20 overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute bottom-16 right-8 sm:bottom-10 sm:right-8 z-10 flex items-center gap-3"
            >
                <a
                    href="https://x.com/rayanboukhanifi"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center bg-white border-2 border-black hover:bg-gray-100 transition-colors"
                >

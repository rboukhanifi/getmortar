...
const Solutions: React.FC = () => {
    return (
        <div className="min-h-screen bg-black text-white font-sans selection:bg-white/30 overflow-x-hidden">
            ...
            {/* Hero Section */}
            <section className="relative min-h-[60vh] flex flex-col justify-center items-center pt-32 pb-20 px-6 overflow-hidden">
                {/* Background Effects */}
                ...
                <div className="max-w-5xl mx-auto relative z-10 text-center">
                    ...
                    <motion.div
                        ...
                        className="mt-64 perspective-1000"
                    >

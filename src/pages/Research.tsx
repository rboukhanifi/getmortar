                    ...
                    <div className="mt-10 flex">
                        ...
                        <div className="space-y-8">
                            ...
                            >
                                ...
                                <h2 className="text-base md:text-lg font-medium mt-1">
                                    <span className="bg-black text-black select-none">2+2=3: More Sensors Produce Less Information in Robotics Data Pipelines</span>
                                </h2>
                                <p className="text-sm mt-1">
                                    <span className="bg-black text-black select-none">[redacted content - classified research]</span>
                                </p>
                            </Link>

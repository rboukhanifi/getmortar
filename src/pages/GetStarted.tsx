            ...
            <main className="h-full flex flex-col justify-center px-6 md:px-12 lg:px-24">
                <div className="max-w-2xl">
                    ...
                    <motion.p
                        ...
                        className="text-sm md:text-base text-gray-400 leading-relaxed mb-10"
                    >
                    ...
                    >
                        <a
                            ...
                            className="inline-block px-8 py-4 bg-white text-black font-medium rounded-lg hover:bg-gray-200 transition-colors"
                        >
                            Apply Here
                        </a>
                    </motion.div>
